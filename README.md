...
Este README corresponde al repositorio backend. El frontend puede ejecutarse en otro repositorio y ambos se unen por la red Docker `uix-shared`.
...
2. Crear variables:
   ...
   cp .env.example .env
   ```
3. Levantar stack backend (MongoDB, Redis, API):
   ```bash
